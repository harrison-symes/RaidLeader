      ...
      <div className="modal-card">
        ...
        <section className="modal-card-body">
          <div className="has-text-centered" id="bossModalID">
            {currentLocation.bosses.map((boss, i) => <i key={i} className={`title has-text-${i + 1 <= defeated.length ? 'success' : 'danger'} is-2 icon ${i + 1 <= defeated.length ? 'ra-unlocking' : 'ra-boss-key'} ra ra-fw is-large`} />)}
