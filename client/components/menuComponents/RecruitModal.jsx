...
const classTraits = heroClass => {
  switch(heroClass) {
    ...
    case 'Warrior': return "The Warrior's attacks deal Critical Damage while the Boss is below (25%) HP"
    ...
    case 'Rogue': return "All attacks have a (20%) chance to deal Critical Damage"
    case 'Monk': return "Whenever the Monk attacks, all Party Members are healed for (50%) of the damage Dealt"
