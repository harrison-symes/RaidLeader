module.exports = {
  ...
  ["Captain's Hook"]: (level, id) => ({
    ...
    effectDescription: "The Necromancer's Starting Buff triggers TWICE!",
    bonusEffect: 'battleCry',
    icon: 'ra-pirate-hook'
  }),
  ["The Black Flag"]: (level, id) => ({
    name: "The Black Flag",
    type: 'weapon',
    level,
    id,
    ...
    class: 'Priest',
    description: "Placeholder",
    effectDescription: "The Priest's Starting Buff triggers TWICE!",
    bonusEffect: 'battleCry',
    icon: 'ra-black-flag'
  }),
  ["Glass Eye"]: (level, id) => ({
    ...
    class: 'Shaman',
    description: "Placeholder",
    effectDescription: "The Shaman's Starting Buff triggers TWICE!",
    bonusEffect: 'battleCry',
    icon: 'ra-brass-eye'
  }),
  ["Rusty Cannon"]: (level, id) => ({
    name: "Rusty Cannon",
    type: 'weapon',
    level,
    id,
    ...
    class: 'Warrior',
    description: "Placeholder",
    effectDescription: "The Warrior's Starting Buff triggers TWICE!",
    bonusEffect: 'battleCry',
    icon: 'ra-cannon'
  }),
  ...
  ["Polly!"]: (level, id) => ({
    ...
    class: 'Hunter',
    description: "Placeholder",
    effectDescription: "The Hunter's Starting Buff triggers TWICE! (Summons two Parrots)",
    bonusEffect: 'battleCry',
    icon: 'ra-parrot-head'
  }),
}
