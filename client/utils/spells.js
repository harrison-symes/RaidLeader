...
module.exports = {
  ...
  'Blood Fury': {
    ...
    perc: 0.15,
    duration: 10,
    description: 'Damage ALL Recruits AND the Player for 15% of their Max Health. Apply the Fury Effect to ALL Recruits, increasing their Power by 20% for 10 seconds.',
    icon: 'ra-blood',
    color: colors.darkPurple,
    background: colors.faintPink,
    element: 'Shadow',
