...
module.exports = {
  ...
  'Purge': {
    ...
    recruitOnly: true,
    percentage: 0.3,
    description: 'Remove ALL effects from a friendly Recruit, heal the target for (30%) of their Max Health for each effect removed. If you have no Life spells, heal twice as much.',
    icon: 'ra-cancel',
    color: colors.darkBlue,
    background: colors.lightBlue,
    element: 'Arcane'
  ...
  'Life Funnel': {
    ...
    ticks: 5,
    isChanneled: true,
    description: "Transfer 5% of Player Health to the target over 3 seconds",
