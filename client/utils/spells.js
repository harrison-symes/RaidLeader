...
module.exports = {
  ...
  'Harvest Life': {
    ...
    singleTarget: false,
    powerRatio: 2,
    description: 'Damage the Boss for and Heal ALL Friendly Characters for (%200) of Player Power',
    icon: 'ra-defibrilate',
    color: colors.darkPurple,
    background: colors.faintPink,
    element: 'Shadow'
  ...
  'Siphon Life': {
    ...
    singleTarget: false,
    isChanneled: true,
    description: 'Damage ALL friendly characters for 100% Player Power over 3 seconds, then heal ALL friendly characters for 250% Player Power',
    icon: 'ra-player-lift',
    color: colors.darkPurple,
    background: colors.faintPink,
    element: 'Shadow'
  ...
  'Ring of Fire': {
    ...
    singleTarget: false,
    isChanneled: true,
    description: 'Damage ALL characters (including the Boss) for 100% Player Power over 3 seconds, then Damage the Boss for 200% Player Power',
    icon: 'ra-fire-ring',
    color: colors.darkRed,
    background: colors.lightOrange,
    element: 'Fire'
  ...
  'Purge': {
    ...
    singleTarget: true,
    percentage: 0.1,
    description: 'Remove ALL effects from a friendly Recruit, heal the target for 10% of their Max Health for each effect removed. If you have no Life spells, heal twice as much.',
    icon: 'ra-cancel',
    color: colors.darkBlue,
    background: colors.lightBlue,
    element: 'Arcane'
