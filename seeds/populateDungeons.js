  ...
  return knex('dungeons').del()
    .then(function () {
      ...
      return knex('dungeons').insert([
        ...
        {id: 3, name: 'The Swamp', level: 2, is_repeatable: true, max_party: 3, max_spells: 3, requires_complete: 'The Cursed Wilds', rewards: JSON.stringify([]), gold_reward: 1000, description: "The once tranquil woods have been overwhelmed by a strange sludge in recent weeks. Many adventurers have sought the source of this plague, but none have returned. That probably means there is a lot of loot to be found here!"},
