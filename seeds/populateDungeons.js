  ...
  return knex('dungeons').del()
    .then(function () {
      ...
      return knex('dungeons').insert([
        ...
        {id: 2, name: 'The Cursed Wilds', level: 1, is_repeatable: true, max_party: 2, max_spells: 2, requires_complete: 'The Hunt', rewards: JSON.stringify([{name: 'Cursed Staff of the Wilds', min: 0, max: 0.7}, {name: 'Cleansed Staff of the Wilds', min: 0.7, max: 1}]), gold_reward: 300, description: "Patrons of the local Town Pub have told stories of the Cursed Wilds, filled with giant beasts who have been acting more aggressively lately. Will you brave the challenge and free these Beasts from the curse?"},
